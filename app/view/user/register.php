        ...
        <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-slate-100 rounded-lg shadow">
            ...
            <form class="mt-8 space-y-6" action="#">
                <div>
                    ...
                    <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Input your username here" required>
                </div>
                <div>
